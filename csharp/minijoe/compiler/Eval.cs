...
public class Eval : JsObject {
  ...
  public static void compile(String input, OutputStream os) {
    ...
    if (Config.DEBUG_SOURCE) {
	  Writer w = new OutputStreamWriter(MySystem.out_);
